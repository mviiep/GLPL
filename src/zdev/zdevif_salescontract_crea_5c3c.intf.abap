interface ZDEVIF_SALESCONTRACT_CREA_5C3C
  public .
  ...
  types:
    TY_S_SALESCONTRACT_CREATED_V1 TYPE STRUCTURE FOR HIERARCHY ZDEV_SalesContract_Created_v1 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salescontract_created_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
