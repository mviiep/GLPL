interface ZDEVIF_SALESCONTRACT_ITEM_7A98
  public .
  ...
  types:
    TY_S_SALESCONTRACT_ITEMCH_483A TYPE STRUCTURE FOR HIERARCHY ZDEV_SalesContract_ItemCh_483A .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salescontract_itemch_483A
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
