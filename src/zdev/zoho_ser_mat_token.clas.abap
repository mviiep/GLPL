CLASS zoho_ser_mat_token DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZOHO_SER_MAT_TOKEN IMPLEMENTATION.
...
*    r_token =
  ...
  METHOD tokenmethod.
    ...
    CASE sy-sysid.
      WHEN lv_dev.
        token_url = 'https://glpl-nonprod-apim-02.azure-api.net/crmsandboxtoken'.
        DATA(lv_sub_key) = '3f3c78ff8cad477c831527f03f71a041'.
      WHEN lv_qas.
        token_url = 'https://glpl-nonprod-apim-02.azure-api.net/crmsandboxtoken'.
        lv_sub_key = '3f3c78ff8cad477c831527f03f71a041'.
      WHEN lv_prd.
        token_url = 'https://glpl-prod-apim-02.azure-api.net/CRMAccesstoken'.
    ...
    SELECT SINGLE *
    FROM zdb_tokentable
    WHERE url_path = 'crmsandboxtoken'
    ...
    IF wa_tokentable-token IS INITIAL OR ( lv_diff GE 3600 ) .
      ...
      IF status-code = 200.
        ...
        IF r_token IS NOT INITIAL.
          wa_tokentab-url_path        = 'crmsandboxtoken'.
