interface ZDEVIF_SALESCONTRACT_ITEM_27A1
  public .
  ...
  types:
    TY_S_SALESCONTRACT_ITEMDE_240C TYPE STRUCTURE FOR HIERARCHY ZDEV_SalesContract_ItemDe_240C .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salescontract_itemde_240C
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
