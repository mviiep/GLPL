interface ZDEVIF_SALESCONTRACT_ITEM_43FD
  public .
  ...
  types:
    TY_S_SALESCONTRACT_ITEMCR_EE17 TYPE STRUCTURE FOR HIERARCHY ZDEV_SalesContract_ItemCr_EE17 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_salescontract_itemcr_EE17
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
